...
class _DownloadScreenState extends State<DownloadScreen> {
  ...
  /// Espace disque disponible en octets, ou -1 si indisponible (plateforme non Android).
  int _freeSpace = -1;
  ...
  Future<void> _playOffline(DownloadTask task) async {
    // Un fichier exporté a été retiré du stockage privé et vit dans le dossier
    // Téléchargements public : on le confie au lecteur vidéo du système.
      ...
      if (!opened && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            ...
            content: Text(
              'Aucune application trouvée pour lire ce fichier. Il reste disponible dans Téléchargements/CHILLERS.',
  ...
  Widget build(BuildContext context) {
    ...
    // Seuls les fichiers du stockage privé consomment de l'espace pour l'application :
    // les exports vivent dans le dossier Téléchargements public.
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_freeSpace > 0) ...[
                              const SizedBox(height: 2),
                              Text(
                                'Espace libre sur l\'appareil : ${_formatBytes(_freeSpace)}',
                                style: const TextStyle(color: AppTheme.textSecondary, fontSize: 11),
                              ),
                            ],
                          ],
    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              if (isDone)
                IconButton(
                  ...
                  tooltip: task.publicUri != null ? 'Ouvrir avec une autre application' : 'Lire hors-ligne',
          ...
          // Erreur : on affiche la raison plutôt qu'une barre de progression figée
