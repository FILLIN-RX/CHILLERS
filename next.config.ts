        ...
        headers: [
          // Allow iframes from streaming providers
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://image.tmdb.org https://images.unsplash.com https://*.tmdb.org https://*.vidzy.cc https://*.gstatic.com https://s0.2mdn.net https://vercel.live https://vercel.com https://*.googlesyndication.com https://*.googleadservices.com https://*.doubleclick.net https://*.googleusercontent.com https://*.i.ibb.co https://upload.wikimedia.org https://i.imgur.com https://jiotvimages.cdn.jio.com",
