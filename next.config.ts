    ...
    return [
      {
        ...
        headers: [
          // Allow iframes from streaming providers
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.youtube.com https://s.ytimg.com https://vercel.live https://pagead2.googlesyndication.com https://*.googlesyndication.com https://googleads.g.doubleclick.net https://*.googleadservices.com",
              "frame-src 'self' https://vidlink.pro https://vidapi.xyz https://doodstream.com https://*.doodstream.com https://d000d.com https://*.d000d.com https://d0000d.com https://playmogo.com https://*.playmogo.com https://*.dood.to https://www.youtube.com https://animekai.to https://*.vidzy.cc https://vidsrc.xyz https://embed.su https://uqload.is https://*.uqload.is https://www.google.com https://*.google.com https://vercel.live https://googleads.g.doubleclick.net https://*.googlesyndication.com https://*.doubleclick.net https://*.googleadservices.com",
