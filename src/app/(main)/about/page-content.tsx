...
import { ArrowLeft, Play, MagnifyingGlass, Heart, ShieldCheckered } from '@phosphor-icons/react';
      ...
      <div className="mx-auto px-6 sm:px-8 md:px-12 lg:px-[4%] py-24 space-y-16">
        ...
        <section className="space-y-6">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <div className="p-5 rounded-2xl bg-zinc-900/60 border border-zinc-800 space-y-3">
              <Play className="h-8 w-8 text-[#7C3AED]" />
        ...
        <section className="space-y-4 p-6 rounded-2xl bg-zinc-900/80 border border-zinc-800">
          <h2 className="text-xl font-black flex items-center gap-3">
            <ShieldCheckered className="h-5 w-5 text-amber-400" />
            Avis de non-responsabilité
          </h2>
