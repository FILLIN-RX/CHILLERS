...
echo ""
echo "Pour Windows (PM2):"
echo "  npm install -g pm2                       # installer pm2"
echo "  pm2 start ecosystem.config.cjs            # démarrer avec l'ecosystem"
echo "  pm2 save                                 # sauvegarder la config"
echo "  pm2 startup                               # démarrage auto au boot"
