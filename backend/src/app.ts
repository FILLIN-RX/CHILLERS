...
import fawesomeRoutes from './modules/fawesome/fawesome.routes';
import freemoviesplusRoutes from './modules/freemoviesplus/freemoviesplus.routes';
import plexRoutes from './modules/plex/plex.routes';
...
app.use('/api/fawesome', fawesomeRoutes);
app.use('/api/freemoviesplus', freemoviesplusRoutes);
